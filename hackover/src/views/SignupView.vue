<template>
    <div class="signup">
        <div class="credentials" :class="activeTab == 0 ? 'active' : ''">
            ...
            <div class="redirect">Already have an account? <RouterLink to="/login">Log In!</RouterLink>
            </div>
        </div>
        <div class="personal" :class="activeTab == 1 ? 'active' : ''">
            ...
            <div class="input">
                ...
                <input type="number" id="hoursperday" v-model="personalData.hoursperday">
            </div>
            <div class="input">
                <label for="yearofstudy">Year of Study</label>
                <input type="number" id="yearofstudy" v-model="personalData.yearofstudy">
            </div>
            <div class="input">
            ...
            <div class="input">
                ...
                <input type="text" id="stressbusters" v-model="personalData.stressbusters">
            </div>
...
const apiUrl = "http://192.168.137.55:8000/"
